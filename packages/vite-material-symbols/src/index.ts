  ...
  return {
    ...
    async load(id) {
      ...
      if (id.startsWith(RESOLVED_ICON_PREFIX)) {
        ...
        // Minimal payload for testing: default export is a tiny object.
        // In your real impl, return the React component or SVG string here.
        const payload = {
          name: glyph,
          svg: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>${glyph}</title><rect width="24" height="24" fill="none"/></svg>`,
        };
        return `
          import { jsx as _jsx } from 'react/jsx-runtime';
          export default function() { 
            return _jsx('div', {
              dangerouslySetInnerHTML: { __html: ${JSON.stringify(payload.svg)} } 
            });
          }
        `;
      }
